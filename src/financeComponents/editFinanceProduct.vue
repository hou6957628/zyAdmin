    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
      ...
      <el-form-item>
        ...
        <el-dialog title="提示" :visible.sync="dialogFormVisible" center>
          <el-form >
            <el-form-item>
              编号：<span style="display: inline-block;width: 250px;margin-right: 5px;margin-bottom: 10px;" v-model.number="ruleForm.productCode">{{ruleForm.productCode}}</span>
              产品名称：<span style="display: inline-block;width: 200px;margin-right: 5px;margin-bottom: 10px;" v-model.number="ruleForm.name">{{ruleForm.name}}</span>
              <p>该产品应用于：{{ruleForm.position}}，编辑后更改内容将在以上产品中同步，是否确定编辑？</p>
            </el-form-item>
          </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      editProduct(data){
        axios({
          method:"post",
          url:"http://"+this.baseUrl+"/operate/admin/product/editProduct",
          headers:{
          ...
          if(res.data.msgCd=='ZYCASH-200'){
            ...
            this.ruleForm.name= res.data.body.name;
            this.ruleForm.description= res.data.body.description;
            this.ruleForm.electValueType= res.data.body.type;
            this.ruleForm.electValueEnabled= res.data.body.enabled;
            this.ruleForm.minCapital= res.data.body.minCapital;
            this.ruleForm.maxCapital= res.data.body.maxCapital;
            this.ruleForm.capitalMultiple= res.data.body.capitalMultiple;
            this.ruleForm.electValueInterestPeriod= res.data.body.interestPeriod;
            this.ruleForm.electValueMethod= res.data.body.interestMethods;
            this.ruleForm.electValuePeriodType= res.data.body.periodType;
            this.ruleForm.electValueInterestRatePeriod= res.data.body.interestRatePeriod;
            this.ruleForm.electValueRevolvingLoan= res.data.body.revolvingLoan;
            this.ruleForm.interestTime= res.data.body.interestTime;
            this.ruleForm.borrowingFeeRateValue= res.data.body.borrowingFeeRateValue;
            this.ruleForm.electValueBorrowingFeePayRule= res.data.body.borrowingFeePayRule;
            this.ruleForm.repaymentFeeRateValue= res.data.body.repaymentFeeRateValue;
            this.ruleForm.electValueEnabledPrepayment= res.data.body.enabledPrepayment;
            this.ruleForm.electValuePrepaymentRule= res.data.body.prepaymentRule;
            this.ruleForm.prepaymentLockedTime= res.data.body.prepaymentLockedTime;
            this.ruleForm.repaymentLeadPenaltyRateValue= res.data.body.repaymentLeadPenaltyRateValue;
            this.ruleForm.electValueRepaymentLagStartTime= res.data.body.repaymentLagStartTime;
            this.ruleForm.repaymentLagPenaltyRateValue= res.data.body.repaymentLagPenaltyRateValue;
            this.ruleForm.repaymentLagTime= res.data.body.repaymentLagTime;
            this.ruleForm.repaymentLagRateValue= res.data.body.repaymentLagRateValue;
            this.electDataList.domains= res.data.body.list;
            this.ruleForm.productCode= res.data.body.productCode;
          }else {
