<template>
  <div class="content">
    ...
    <div class="operationContent">
      ...
      <el-button @click="downloadW()" icon="el-icon-download el-icon-right" type="primary">导出</el-button>
    </div>
    <template>
      <el-table
        :data="tableData"
  ...
  export default {
    methods: {
      ...
      searchContent(){
        if (this.status=='') {
          this.getOrderList(this.productId,this.status,this.mobile,this.repaymentOverdueDay,this.orderRepaymentDate,
            this.orderDate,this.repaymentPaymentDate,this.reBorrow,1,this.pageSize,1,this.outSourceStatus);
        } else {
          this.getOrderList(this.productId,this.status,this.mobile,this.repaymentOverdueDay,this.orderRepaymentDate,
            this.orderDate,this.repaymentPaymentDate,this.reBorrow,1,this.pageSize,null,this.outSourceStatus);
        }
      },
      //每页显示多少条
      handleSizeChange(val) {
        if (this.status=='') {
          this.getOrderList(this.productId,this.status,this.mobile,this.repaymentOverdueDay,this.orderRepaymentDate,
            this.orderDate,this.repaymentPaymentDate,this.reBorrow,this.pageNum,val,1,this.outSourceStatus);
        } else {
          this.getOrderList(this.productId,this.status,this.mobile,this.repaymentOverdueDay,this.orderRepaymentDate,
            this.orderDate,this.repaymentPaymentDate,this.reBorrow,this.pageNum,val,null,this.outSourceStatus);
        }
      ...
      handleCurrentChange(val) {
        if (this.status=='') {
          this.getOrderList(this.productId,this.status,this.mobile,this.repaymentOverdueDay,this.orderRepaymentDate,
            this.orderDate,this.repaymentPaymentDate,this.reBorrow,val,this.nowPageSizes,1,this.outSourceStatus);
        } else {
          this.getOrderList(this.productId,this.status,this.mobile,this.repaymentOverdueDay,this.orderRepaymentDate,
            this.orderDate,this.repaymentPaymentDate,this.reBorrow,val,this.nowPageSizes,null,this.outSourceStatus);
        }
      },
      //查询产品列表
      getProductList(){
       ...
       * @param data12 委外状态1是委外
       */
      getOrderList(data1,data2,data3,data4,data5,data6,data7,data8,data9,data10,data11,data12){
      ...
      downloadW(){
        ...
        let repaymentPaymentEndDate = null;
        let orderType = null;
        if (this.orderRepaymentDate!='' & this.orderRepaymentDate!=null) {
          orderRepaymentStartDate=this.orderRepaymentDate[0];
          orderRepaymentEndDate=this.orderRepaymentDate[1];
        }
        if (this.orderDate!='' & this.orderDate!=null) {
          orderStartDate=this.orderDate[0];
          orderEndDate=this.orderDate[1];
        }
        if (this.repaymentPaymentDate!='' & this.repaymentPaymentDate!=null) {
          repaymentPaymentStartDate=this.repaymentPaymentDate[0];
          repaymentPaymentEndDate=this.repaymentPaymentDate[1];
        }
        if (this.status == '') {
          orderType = 1;
        }
        axios({
          method:"POST",
          url:"http://"+this.baseUrl+"/order/admin/borrowing/getOrderListExport",
          headers:{
          ...
          params:{
            ...
            status: this.status,
            mobile: this.mobile,
            repaymentOverdueDay: this.repaymentOverdueDay,
            orderRepaymentStartDate: orderRepaymentStartDate,
            orderRepaymentEndDate: orderRepaymentEndDate,
            orderStartDate: orderStartDate,
            orderEndDate: orderEndDate,
            ...
            orderType: orderType,
            outSourceStatus: this.outSourceStatus,
        }
        }).then((res)=>{
      ...
      download1(data) {
        ...
        link.href = url;
        link.setAttribute('download', '委外订单.xls');
