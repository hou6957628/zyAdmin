<template>
  <div class="content">
    <el-breadcrumb class="fs-16" separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/smsMessage' }">提醒消息</el-breadcrumb-item>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="160px" class="demo-ruleForm">
      ...
      <el-form-item label="已有ICON图标：" v-if="ruleForm.picture">
        <img style="height: 108px;width: 170px" :src="ruleForm.picture"/>
      </el-form-item>
      <el-form-item label="点此修改ICON图标：" prop="fileName">
          ...
          if (valid) {
            ...
            axios({
              ...
              if (res.data.msgCd == 'ZYCASH-200') {
                ...
                this.$router.push('/reminderMessage');
              } else if (res.data.msgCd == 'ZYCASH-1009') {
                this.$message.error(res.data.msgInfo);
              }
              else {
