<template>
  <div class="content">
    <el-breadcrumb class="fs-16" separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>提醒消息</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="operationContent">
      <div style="margin-bottom: 20px">
        <el-button class="upLoadBtn" @click="toAddProduct()" type="primary">创建提醒&nbsp;<i class="el-icon-upload el-icon-circle-plus"></i></el-button>
