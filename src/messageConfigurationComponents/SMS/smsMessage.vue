  ...
  <div class="content">
    ...
    <div class="operationContent">
      <div style="margin-bottom: 20px">
        <el-button class="upLoadBtn" @click="toAddProduct()" type="primary">创建短信&nbsp;<i class="el-icon-upload el-icon-circle-plus"></i></el-button>
    ...
    <el-dialog
      ...
      <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="120px" class="demo-ruleForm">
        <el-form-item label="选择所属APP：" prop="productId">
          <el-select style="width: 320px" v-model="ruleForm2.productId" value-key="id" placeholder="请选择" @change="selectChange1($event,productList)">
            <el-option
        ...
        <el-form-item label="短信ID：" prop="noteId">
          <el-input v-model="ruleForm2.noteId" placeholder="请输入短信ID"></el-input>
        </el-form-item>
        <el-form-item>
  ...
  export default {
    methods: {
      ...
      copeProductTip(row){
        ...
        this.ruleForm2.productId='';
        this.ruleForm2.noteId='';
      },
      //分类列表
      toMessageClassify(){
        this.$router.push({
