<template>
  <div class="content">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="160px" class="demo-ruleForm">
      ...
      <el-form-item style="margin-top: 20px" label="请选择位置：" prop="classifyId">
        <el-select v-model="ruleForm.positionId" value-key="id" placeholder="请选择" @change="selectChange2($event,messagePositionList)">
          <el-option
