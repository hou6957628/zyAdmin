<template>
  <div class="content">
    <el-breadcrumb class="fs-16" separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/pendingLoan' }">放款记录列表</el-breadcrumb-item>
    ...
    <div class="listContent">
      <router-link :to="'/jibenOrder5/'+this.id+'/'+this.orderId2" tag="li">基本信息</router-link>
      <router-link :to="'/fenxianOrder5/' + this.id" tag="li">风险命中列表</router-link>
      <router-link :to="'/yunyingOrder5/' + this.id" tag="li">运营商通讯录比对</router-link>
      ...
      <router-link :to="'/yonghuOrder5/' + this.id" tag="li">用户催收记录</router-link>
      <router-link :to="'/dingdanOrder5/' + this.id" tag="li">订单记录</router-link>
      <router-link :to="'/fangkuanOrder5/' + this.id" tag="li">放款记录</router-link>
      <router-link :to="'/huankuanOrder5/' + this.id" tag="li">还款记录</router-link>
    </div>
    <router-view/>
  </div>
</template>
